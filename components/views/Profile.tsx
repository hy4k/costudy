...
export const Profile: React.FC<ProfileProps> = ({ onLogout, userId, onProfileUpdate }) => {
    ...
    const [editForm, setEditForm] = useState({
        ...
        avatar: '',
        signalLevel: SignalLevel.ACTIVE_SOLVER,
        // Mentor Fields
            ...
            try {
                ...
                if (data) {
                    ...
                    setEditForm({
                        ...
                        avatar: data.avatar || '',
                        signalLevel: data.signalLevel || SignalLevel.ACTIVE_SOLVER,
    ...
    const currentSignal = SignalConfig[me.signalLevel] || SignalConfig[SignalLevel.ACTIVE_SOLVER];
