INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  '7e48129a-35ae-41a2-9cb8-8bb3f7227578',
  'cma_p1_d',
  'Cost Management',
  'Following is a manufacturing company''s fixed overhead data used in developing its fixed overhead standard for the year and the actual data for the year. Overhead is applied based on standard machine hours per unit.
...
What was the standard number of machine hours allowed per unit?',
  '[{"key":"A","text":"1.75 machine hours per unit."},{"key":"B","text":"2.25 machine hours per unit."},{"key":"C","text":"1.96 machine hours per unit."},{"key":"D","text":"2 machine hours per unit."}]'::jsonb,
  'D',
  '',
  'medium',
  103,
  '{"source":"elance","section":"D"}'::jsonb
);
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Corporation manufactures products C, D, and E from a joint process. Joint costs are allocated on the basis of relative sales value at split-off. Additional information is presented below
...
How much of the joint costs should Warfield allocate to product D?',
  '[{"key":"A","text":"32000"},{"key":"B","text":"24000"},{"key":"C","text":"28800"},{"key":"D","text":"30000"}]'::jsonb,
  'D',
  '',
  'medium',
  104,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Meridian Company has established the following support cost pools and activity consumption cost drivers for October 20X7:
...
What is the total support cost assigned to Job C1 using Activity-Based Costing?',
  '[{"key":"A","text":"$39,600."},{"key":"B","text":"$15,000."},{"key":"C","text":"$34,300."},{"key":"D","text":"$26,300"}]'::jsonb,
  'D',
  '',
  'medium',
  105,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'MerrylandCo. manufactures a single product. Shown below are cost and sales data for the first year of operations. During the year, 10,000 finished units were manufactured, of which 9,000 were sold.
...
Under variable costing, the valuations assigned to the ending inventory of finished goods and to the cost of goods sold are',
  '[{"key":"A","text":"ending inventory $20000 and cost of goods sold $180000."},{"key":"B","text":"ending inventory $40,000 and cost of goods sold $160,000."},{"key":"C","text":"ending inventory $80,000 and cost of goods sold $200,000."},{"key":"D","text":"ending inventory $48,000 and cost of goods sold $192,000."}]'::jsonb,
  'A',
  '',
  'medium',
  106,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Nikkoy Productions uses the following capacity levels for 20X5 in its decision making for the year:
...
The company''s fixed manufacturing cost is $9,000,000 per year. During 20X5, ABC produced 14,250,000 units. How much did ABC''s unused capacity cost the company during the year?',
  '[{"key":"A","text":"$375,000."},{"key":"B","text":"$703,125."},{"key":"C","text":"$394,737."},{"key":"D","text":"$450,000"}]'::jsonb,
  'D',
  '',
  'medium',
  107,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Datson Company has two service departments, Human Resources (HR) and Accounting (AC), and two production departments, Milling and Assembly. Departmental data for the month of May were as follows:
...
How much service department costs are allocated to the Milling department if the company uses the reciprocal method of allocating its service department costs? (Round calculations to the nearest whole number.)',
  '[{"key":"A","text":"$23,051."},{"key":"B","text":"$21,949."},{"key":"C","text":"$18,900."},{"key":"D","text":"$33,878"}]'::jsonb,
  'D',
  '',
  'medium',
  108,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'A paper manufacturer produces letter-sized paper and legal-sized paper as joint products and lignin as a byproduct. The letter-sized paper sells for $7.50 per ream and the legal-sized paper sells for $10.00 per ream.
...
What is the joint cost allocated to the letter-sized paper? (round to the nearest figure)',
  '[{"key":"A","text":"$1,050,000."},{"key":"B","text":"$810,000"},{"key":"C","text":"$906,000."},{"key":"D","text":"$930,000"}]'::jsonb,
  'B',
  '',
  'medium',
  109,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'A company produces and sells a single product. For the first quarter the company reports an operating profit of $90,000 under absorption costing. If the company reports operating profit using variable (direct) costing, operating profit falls by $8,000. If manufacturing fixed costs were $80,000 and budgeted production units were 2,000 units, what happened to inventory of finished goods during the period?',
  '[{"key":"A","text":"Decreased by 150 units"},{"key":"B","text":"Increased by 150 units."},{"key":"C","text":"Increased by 200 units."},{"key":"D","text":"Decreased by 50 units"}]'::jsonb,
  'C',
  '',
  'medium',
  110,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'A textile manufacturing company has the following information for its service departments, IT and Payroll department, and its production departments, Knitting and Sewing.
...
Using the step-down method of shared services cost allocation, how much is to be allocated from Payroll to Sewing? (Round to the nearest dollar.)',
  '[{"key":"A","text":"$10,411"},{"key":"B","text":"$12,840"},{"key":"C","text":"$9,630"},{"key":"D","text":"$18,000"}]'::jsonb,
  'D',
  '',
  'medium',
  111,
...
Using the reciprocal method of shared services cost allocation, how much is the total overhead cost for Knitting for the period? (Round to the nearest dollar.)',
  '[{"key":"A","text":"$30,876"},{"key":"B","text":"$30,760"},{"key":"C","text":"$40,243"},{"key":"D","text":"$27,360"}]'::jsonb,
  'C',
  '',
  'medium',
  112,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Victory Company manufactures a variety of products. Champion had been using a traditional overhead allocation system based on machine hours. For the current year, Champion decided to use an activity-based costing system using machine hours and the number of inspections as measures of activity. Information on these measures of activity and related overhead rates for the current year is as follows:
...
Job CC-2 required 15 machine hours and 2 inspections. In comparing ABC with traditional costing, under which costing system would more overhead costs be allocated to Job CC-2, and by how much?',
  '[{"key":"A","text":"Traditional by $455.00"},{"key":"B","text":"ABC by $32.00"},{"key":"C","text":"ABC by $38.50"},{"key":"D","text":"Traditional by $31.50"}]'::jsonb,
  'B',
  '',
  'medium',
  113,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'For all of the benefits of using standard costing there are some limitations to its use. All of the following statements are true concerning limitations of standard costing except',
  '[{"key":"A","text":"The use of standard costing could lead to overemphasis on quantitative measures."},{"key":"B","text":"The less standardized the process, the less useful standard costs become."},{"key":"C","text":"The standards can be based only on a division''s own cost."},{"key":"D","text":"It may be difficult to determine an accurate standard cost, particularly if the business environment is constantly changing"}]'::jsonb,
  'C',
  '',
  'medium',
  114,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Beautiful Flooring manufactures wood flooring panels through three sequential departments: Cutting, Laminating, and Finishing. During April, the Laminating Department received 8,000 units from the Cutting Department with a total transferred-in cost of $64,000. During the month, 6,000 units were completed and transferred to the Finishing Department, 1,500 units remained in ending work-in-process inventory (60% complete for conversion), and 500 units were spoiled. Spoilage is considered normal and is detected at the end of the process.

How should the Laminating Department account for the $64,000 in transferred-in costs?',
  '[{"key":"A","text":"Allocate all $64,000 of transferred-in costs to the 6,000 units transferred out to Finishing."},{"key":"B","text":"Expense the portion of transferred-in costs assigned to spoiled units as a loss."},{"key":"C","text":"Allocate the $64,000 of transferred-in costs between ending work-in-process inventory in the Laminating Department and units completed and transferred out to Finishing on the basis of equivalent units, adding the costs associated with the normally spoiled units to the costs of the good, completed units in the cost allocation."},{"key":"D","text":"Allocate the $64,000 less the cost of the spoiled units to the 6,000 transferred out units and the 1,500 ending inventory units."}]'::jsonb,
  'C',
  '',
  'medium',
  115,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'Datson Company manufactures three main products M, P, and Q from a joint process. Joint costs are allocated on the basis of relative sales value at split-off. Additional information for June production activity follows:
...
Assuming that the 10,000 units of Q were processed further and sold for $78,000, what was Ashwood''s gross profit on this sale?',
  '[{"key":"A","text":"$21,000"},{"key":"B","text":"$36,000"},{"key":"C","text":"$28,500"},{"key":"D","text":"$30,000"}]'::jsonb,
  'D',
  '',
  'medium',
  116,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  '[{"key":"A","text":"Cost per unit is just one area of competitiveness; others should be looked at."},{"key":"B","text":"Companies operate very differently, and comparisons should not be made."},{"key":"C","text":"Fixed overhead is difficult to control and should not be benchmarked."},{"key":"D","text":"Benchmarking should be performed with companies of similar size and sales."}]'::jsonb,
  'D',
  '',
  'medium',
  117,
...
If the corporation prorates any overapplied or underapplied overhead at the end of the year, cost of goods sold after proration would total',
  '[{"key":"A","text":"$127,100"},{"key":"B","text":"$118,900"},{"key":"C","text":"$140,150"},{"key":"D","text":"$125,460"}]'::jsonb,
  'D',
  '',
  'medium',
  118,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'A Johnson and Martin manufacturer has the following unit costs for the month of June:
...
A total of 100,000 units were manufactured during June, 10,000 of which remain in ending inventory. The manufacturer uses the first-in, first-out (FIFO) inventory method, and the 12,000 units are the only finished goods inventory at month end. Using the full absorption costing method, the manufacturer''s finished goods inventory value would be',
  '[{"key":"A","text":"$70,000"},{"key":"B","text":"$84,000"},{"key":"C","text":"$85,000"},{"key":"D","text":"$50,000"}]'::jsonb,
  'B',
  '',
  'medium',
  119,
...
What is the total cost related to prevention?',
  '[{"key":"A","text":"$10,000"},{"key":"B","text":"$5,000"},{"key":"C","text":"$14,000"},{"key":"D","text":"$165,000"}]'::jsonb,
  'C',
  '',
  'medium',
  120,
...
INSERT INTO public.mcq_questions (exam_id, section_id, topic, stem, choices, correct_key, explanation, difficulty, position, metadata) VALUES (
  ...
  'cma_p1_d',
  'Cost Management',
  'A company applies factory overhead based upon machine hours. At the beginning of the year, the company budgeted factory overhead at $248,000 and estimated that 100,000 machine hours would be used to make 50,000 units of product. During the year, the company produced 48,000 units using 97,000 machine hours. Actual overhead for the year was $252,000. Under a standard cost system, the amount of factory overhead applied during the year was',
  '[{"key":"A","text":"$242,500"},{"key":"B","text":"$240,000"},{"key":"C","text":"$252,000"},{"key":"D","text":"$238,080"}]'::jsonb,
  'D',
  '',
  'medium',
  121,
...
The amount of joint production cost that the company would allocate to the Second Main Product by using the physical-volume method to allocate joint production costs would be',
  '[{"key":"A","text":"$1,575,000"},{"key":"B","text":"$1,600,000"},{"key":"C","text":"$1,260,000"},{"key":"D","text":"$1,500,000"}]'::jsonb,
  'B',
  '',
  'medium',
  124,
