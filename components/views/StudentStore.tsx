        ...
        <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-full max-w-6xl">
                {PRODUCTS.map(product => (
                    <div key={product.id} className="bg-white/70 backdrop-blur-2xl border border-slate-200 p-12 rounded-[5rem] shadow-xl hover:shadow-2xl transition-all flex flex-col group">
